  ...
  return (
    <View style={tw`bg-white/90 flex-1 px-6`}>
      <View style={tw`items-center mt-24 mb-14`}>
        ...
        <Text style={tw`text-zinc-500 text-base`}>{user?.email}</Text>
      </View>

      <View style={tw`bg-zinc-100 border border-zinc-200 rounded-3xl p-6 mb-6`}>
        <Text style={tw`text-zinc-500 text-sm mb-2`}>Full Name</Text>

        <Text style={tw`text-zinc-800 text-lg font-semibold mb-6`}>
          {user?.name}
        </Text>

        <Text style={tw`text-zinc-500 text-sm mb-2`}>Email Address</Text>
      ...
      <Link
        href={"/editProfile"}
        style={tw`bg-zinc-100 border border-zinc-200 rounded-3xl mb-4`}
      >
        <TouchableOpacity style={tw`flex-row items-center justify-between p-5`}>
          <View style={tw`flex-row items-center`}>
            <Ionicons name="person-outline" size={22} color="black" />
            <Text style={tw`text-zinc-800 ml-4 text-base`}>Edit Profile</Text>
          </View>
